# Deadline Scheduler
(will choose a better name as the project progresses)

The purpose of this project is to build a simple, kinda student focused deadline scheduler. Simple calendar apps just create events and do not actively display you whats important,
what is to be done for the day. This project is to help you with that.
